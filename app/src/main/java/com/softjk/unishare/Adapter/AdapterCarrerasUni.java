...
public class AdapterCarrerasUni extends FirestoreRecyclerAdapter<Carreras, AdapterCarrerasUni.ViewHolder> {
    Activity activity;
    private FirebaseAuth mAuth;
    private FirebaseFirestore mFirestore = FirebaseFirestore.getInstance();
    ProgressDialog progressDialog;
    public AdapterCarrerasUni(@NonNull FirestoreRecyclerOptions<Carreras> options, Activity activity) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull AdapterCarrerasUni.ViewHolder viewHolder, int i, @NonNull Carreras carreras) {
...
String Estado ="Puebla";
        ...
        //System.out.println("ver Adapter daatos recibidos Ruta= "+Estado+"/"+idUser+"/"+Carrera+" Documento= "+id);
        mFirestore.collection(Estado+"/"+idUser+"/Carreras").document(id).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
    ...
    @NonNull
    @Override
    public AdapterCarrerasUni.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
