...
class AdapterEspecialUni(options: FirestoreRecyclerOptions<Carreras?>,private var activity: Activity) :
    FirestoreRecyclerAdapter<Carreras, AdapterEspecialUni.ViewHolder>(options) {
    ...
    private fun EliminarCarr(id: String) {
        ...
        mFirestore.collection("$Estado/$idUser/Especializaciones").document(id).delete()
