...
public class AdapterDoctUni extends FirestoreRecyclerAdapter<Carreras, AdapterDoctUni.ViewHolder> {
    Activity activity;
    private FirebaseAuth mAuth;
    private FirebaseFirestore mFirestore = FirebaseFirestore.getInstance();
    ProgressDialog progressDialog;
    public AdapterDoctUni(@NonNull FirestoreRecyclerOptions<Carreras> options, Activity activity) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull AdapterDoctUni.ViewHolder viewHolder, int i, @NonNull Carreras carreras) {
    ...
    private void EliminarCarr(String id) {
      ...
      //  System.out.println("ver Adapter daatos recibidos Ruta= "+Estado+"/"+idUser+"/Maestrias + Documento= "+id);
        mFirestore.collection(Estado+"/"+idUser+"/Doctorado").document(id).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
    ...
    @NonNull
    @Override
    public AdapterDoctUni.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
