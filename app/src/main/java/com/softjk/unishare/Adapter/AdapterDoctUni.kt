...
class AdapterDoctUni(options: FirestoreRecyclerOptions<Carreras?>, var activity: Activity) :
    FirestoreRecyclerAdapter<Carreras, AdapterDoctUni.ViewHolder>(options) {
    ...
    private fun EliminarCarr(id: String) {
        ...
        mFirestore.collection("$Estado/$idUser/Doctorado").document(id).delete()
